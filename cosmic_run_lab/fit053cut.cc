...
//    tree->Project( "H1949_pe", condi, "tdc[1]>0&&qdc[1]>0&&tdc[4]+1.115*tdc[5]>1020&&tdc[4]+1.115*tdc[5]<1070" );
    ...
    H7195_pe = new TH1D("H7195_pe","H7195_pe",175,-5,30);
    ...
    SetTH1(Total,"Total","Number of photoelectron","Coutns");
...
//    tree->Project( "H7195_pe", condi2, "tdc[2]>0&&qdc[2]>0&&tdc[4]+1.115*tdc[5]>1020&&tdc[4]+1.115*tdc[5]<1070" );
    ...
    tree->Project("Total", condi, "qdc[0]>600&&qdc[3]>1000&&tdc[1]>0&&tdc[2]>0&&qdc[1]>0&&qdc[2]>0&&tdc[4]>0&&tdc[5]>0&&(tdc[4]+1.115*tdc[5]>1070||tdc[4]+1.115*tdc[5]<1020)");

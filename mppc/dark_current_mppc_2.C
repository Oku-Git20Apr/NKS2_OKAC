...
void dark_current_mppc_2() {


    cout<<"before file open"<<endl;

	TChain *tree = new TChain("tree");
	tree->Add("r0000217.root");
	...
	TH1D *h_qdc[7];
      h_qdc[0] = new TH1D("h_qdc[0]","h_qdc[0]",300,250.,550.);
	  tree->Project("h_qdc[0]","qdc[0]","","");
	  SetTH1(h_qdc[0],"QDC distribution","QDC [ch]","Counts");

	  tree->Reset();

	  tree->Add("r0000219.root");
      h_qdc[1] = new TH1D("h_qdc[1]","h_qdc[1]",300,250.,550.);
	  tree->Project("h_qdc[1]","qdc[0]","","");
	  SetTH1(h_qdc[1],"QDC distribution","QDC [ch]","Counts");

	  tree->Reset();

	  tree->Add("r0000221.root");
      h_qdc[2] = new TH1D("h_qdc[2]","h_qdc[2]",300,250.,550.);
	  tree->Project("h_qdc[2]","qdc[0]","","");
	  SetTH1(h_qdc[2],"QDC distribution","QDC [ch]","Counts");

	  tree->Reset();

	  tree->Add("r0000223.root");
      h_qdc[3] = new TH1D("h_qdc[3]","h_qdc[3]",300,250.,550.);
      ...
      h_qdc[4] = new TH1D("h_qdc[4]","h_qdc[4]",300,250.,550.);

...
void draw(){
  ...
  float peak_pe[2] = { 319.8, 195.6 };
    ...
    ch1_ohhldadc = new TH1D("ch1_ohhldadc","ch1_ohhldadc",1000,0,3000);  //ohhldadc channel
    ...
    ch2_ohhldadc = new TH1D("ch2_ohhldadc","ch2_ohhldadc",1000,0,3000);  //ohhldadc channel
  ...
  sprintf( condi, "(ohhldadc[7]-%f)/%f+(ohhldadc[8]-%f)/%f",pedestal[0], peak_pe[0]-pedestal[0], pedestal[1], peak_pe[1]-pedestal[1] );
    ...
    tree->Project("Total", condi, "ohhldtdc[7]>0&&ohhldtdc[8]>0&&ohhldadc[7]>0&&ohhldadc[8]>0&abs(ohhldadc[3]-1000)<500&&abs(ohhldadc[6]-1850)<350");

 TF1 *f1 = new TF1("f1",F_Pois,0,15,3);
  f1->SetNpx(500);
  f1->SetParameters(lambda,res,roop);
  Total->Fit(f1,"0","",0,15);    //fitting

...
//////////////////////////////////////////////////////////////////////////////
void macro_soturon_fit_10680_ohhldadc4_spe(){
  ...
  TH1D *Hist;     //qdc[1]
  Hist = new TH1D("Hist","Hist",100,0.,1000);  //qdc channel
  tree->Project("Hist","ohhldadc[4]","ohhldtdc[4]>0","");

  char condi[1000];

  TF1 *f1 = new TF1("f1","gaus",80.,270.);

...
void draw(){
  ...
  double lambda = 15.;    //average of #photon
  double res = 0.68;      //energy resolution factor
  int roop = 3000;        //menseki
  ...
  sprintf( condi, "(ohhldadc[4]-%f)/%f+(ohhldadc[5]-%f)/%f+10",pedestal[0], peak_pe[0]-pedestal[0], pedestal[1], peak_pe[1]-pedestal[1] );


    tree->Project("Total", condi, "ohhldtdc[4]>0&&ohhldtdc[5]>0&&ohhldadc[4]>0&&ohhldadc[5]>0&&ohhldtdc[3]-ohhldtdc[6]>-100&&ohhldtdc[3]-ohhldtdc[6]<100");
